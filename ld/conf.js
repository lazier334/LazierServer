...
export const userConfig = {
    ...
    appendButsData: [
        ...
        {
            update(self, config) {
                self.avatarText = config.switch.simpleLog
            },
            // avatarText: 'false',
            text: '精简日志',
            tooltip: '精简控制台日志',
        ...
        {
            update(self, config) {
                self.avatarText = config.switch.autoComplete
            },
            // avatarText: 'false',
            text: '自动补全',
            tooltip: '自动补全',
...
import { warpKoaCtxByWeb, types } from 'lazierserver';

/**
 * koa 路由插件的demo
 */
export default types.createKoaRouter(function koaRouterDemo(router) {
    if (false) {
